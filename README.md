...
n8n is configured with `N8N_BLOCK_ENV_ACCESS_IN_NODE: false`, which allows Code nodes to access environment variables. This is used for integrations like Browserless:
...
These variables are auto-generated by `init-env.sh` and stored in `.env`.
