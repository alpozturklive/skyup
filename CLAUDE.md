...
SkyUp is a self-hosted application stack (Release v2.1 - Memory) that runs AI applications and workflow tools using **Podman** and **podman-compose**. It's designed for host-only access (127.0.0.1) with optional HTTPS setup for production.
